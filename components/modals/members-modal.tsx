...
import { Check, Copy, MoreVertical, RefreshCw, ShieldAlert, ShieldCheck, ShieldQuestion ,Shield, Gavel, Loader2} from "lucide-react";
      ...
      <DialogContent className="bg-white text-black p-0 overflow-hidden">
        ...
        {server?.members?.map((member) => (<div key={member.id} className="flex items-center gap-x-2 mb-6">
            ...
            <div className="flex flex-col gap-y-1 ">
                <div className="text-xs font-semibold flex items-center gap-x-1">{member.profile.name}
                {roleIconMap[member.role]}</div>
